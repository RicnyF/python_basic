...
def main():
    bod=0
    otazka1 = input("Vymaz ze zadaneho identifikatoru znaky tak aby byl spravne 'T8On_da4':")
    otazka2 = input("Je python integrovany nebo kompilovany jazyk (odpoved 1 nebo 2):")
    otazka3 = input("V pythonu se pouzivaji {} v podminkach (odpoved ano nebo ne):")
    if otazka1=="n_da4":
        bod+=1
    if otazka2=="1":
        bod+=1
